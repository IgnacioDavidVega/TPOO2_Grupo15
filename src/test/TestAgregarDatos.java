...
public class TestAgregarDatos {
 ...
 try {
     ...
     festivalNavidad = festivalABM.traer(idFestival);
     System.out.println("Festival creado: " + festivalNavidad);
 } catch (Exception e) {
     System.err.println("Error al crear el festival de Tomas: " + e.getMessage());
 }

 try {
     if (festivalNavidad != null) {
         int idU1 = uvABM.agregar("La Parrilla de Miguel", null, 20, "LAPAR00001", festivalNavidad, "aaa111", true);
         uvParrillaMiguel = uvABM.traer(idU1);

         int idU2 = uvABM.agregar("El Café de Lara", null, 30, "ELCAF00002", festivalNavidad, 3L, 60L);
         uvCafeLara = uvABM.traer(idU2);

         int idU3 = uvABM.agregar("Helados Martin", null, 20, "HELAD00003", festivalNavidad, "bbb222", true);
 ...
 try {
     if (uvParrillaMiguel != null && uvCafeLara != null && uvHeladosMartin != null) {
         ...
         personalABM.agregar("Luis", "Perez", 222222, LocalDate.of(1996, 11, 2),
                 LocalDate.now().minusDays(5), 500000.0, uvParrillaMiguel, "Tarde");
         ...
         personalABM.agregar("Nahuel", "Dias", 444444, LocalDate.of(2001, 9, 19),
                 LocalDate.now().minusDays(5), 500000.0, uvCafeLara, "Tarde");
         ...
         personalABM.agregar("Tomas", "Casco", 666666, LocalDate.of(1999, 7, 30),
                 LocalDate.now().minusDays(5), 500000.0, uvHeladosMartin, "Tarde");
